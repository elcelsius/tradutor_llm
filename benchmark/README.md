...
Baseline atual do projeto, definido em `config.yaml` após a matriz e2e:
`mistral-small3.2:24b-instruct-2506-q4_K_M` na tradução e
`gemma4:26b-a4b-it-q4_K_M` no refine.
...
python -m tradutor.bench_e2e_llms \
  ...
  --translate-models gemma4:26b-a4b-it-q4_K_M mistral-small3.1:24b-instruct-2503-q4_K_M \
  --refine-models gemma4:26b-a4b-it-q4_K_M mistral-small3.1:24b-instruct-2503-q4_K_M \
  --max-chars 2500 \
