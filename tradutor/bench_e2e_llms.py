"""
Benchmark end-to-end para comparar combinacoes de tradutor e refinador.

O fluxo executa leitura/extracao, preprocessamento, desquebra deterministica
opcional, traducao pelo pipeline real, refine pelo pipeline real e QA final.
Por padrao testa todas as combinacoes informadas.
"""
